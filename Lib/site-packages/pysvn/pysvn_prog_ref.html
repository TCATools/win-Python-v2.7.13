...
<p>
Showing the PySVN API supported by SVN <span id="version_shown">1.6.0</span>.
...
<li><a href="#pysvn_depth">depth</a> - replacement for recurse</li>
</ul>
...
tuple of three values (retcode, certfile, may_save).
</p>
<ul>
...
<h4><a name="pysvn_client_add_to_changelist"><a href="#pysvn_module">pysvn</a>.<a href="#pysvn_client">Client</a>.add_to_changelist</a></h4>
<pre>
...
<div class="svn_1005000">
<p>depth is one of the pysvn.depth enums.
</p>
</div>
...
checkin( path,
        ...
        keep_locks=False</span><span class="svn_1005000">,
        depth,
        keep_changelist,
        changelists,
...
<p>sources is a list of tuples of (url_or_path, rev), you can ommit rev by passing (url_or_path,).
TBD better docs here.</p>

<p>revprops TBD</p>

<div class="svn_1006000">
<p>set ignore_externals to True to ignore externals.
</p>
</div>
...
<div class="svn_1006000">
<p> If relative_to_dir is not None, the original_path and
 modified_path will have the relative_to_dir stripped from the
 front of the respective paths.
</p>
<p>If relative_to_dir is not
 None but relative_to_dir is not a parent path of the target,
...
diff_summarize( url_or_path1,
                ...
                revision2=pysvn.Revision( opt_revision_kind.working ),
                recurse=True,
                ignore_ancestry=False<span class="svn_1005000">,
                depth=depth</span> )
</pre>
<p>
...
<div class="svn_1005000">
<h4><a name="pysvn_client_get_changelist"><a href="#pysvn_module">pysvn</a>.<a href="#pysvn_client">Client</a>.get_changelist</a></h4>
<pre>
changelist_list = \
get_changelist( path,
                changelist,
...
<p>The depth is one of the pysvn.depth enums.
</p>
...
import_( path,
         ...
         ignore=False</span><span class="svn_1005000">,
         revprops</span><span class="svn_1008000">,
         autoprops=False</span> )
</pre>
<p>
...
<div class="svn_1007000">
<p>
If fetch_excluded is True, also also send excluded nodes in the working
copy to receiver, otherwise these are skipped.
</p>
<p>If fetch_actual_only
...
<div class="svn_1005000">
<h4><a name="pysvn_client_root_url_from_path"><a href="#pysvn_module">pysvn</a>.<a href="#pysvn_client">Client</a>.root_url_from_path</a></h4>
<pre>
root_url = \
    root_url_from_path( url_or_path )
</pre>
<p>Return the root URL of the repository given the url_or_path.
</p>
</div>
...
<li>2 - external_parent_url - string or None</li>
<li>3 - external_target - string or None</li>
</ul>
...
<div class="svn_1008000">
<p>
If list() was called with include_externals set to True,
external_parent_url and external_target will be set.
external_parent_url is url of the directory which has the
externals definitions. external_target is the target subdirectory of
...
log( url_or_path,
     ...
     limit=0</span><span class="svn_1004000">,
     peg_revision=pysvn.Revision( opt_revision_kind.unspecified )</span><span class="svn_1005000">,
     include_merged_revisions=False,
     revprops=list_of_revprop_names</span> )
</pre>
<p>
...
<div class="svn_1004000">
<p>If url_or_path no longer exists in the repos of WC then pass in a peg_revision of a revision where it did exist.</p>
</div>
<div class="svn_1005000">
<p>include_merged_revisions TBD
</p>
<p>revprops is a list of strings that name the revprops to be returned.
</p>
</div>
...
merge( url_or_path1,
       ...
       depth=depth,
       record_only=False,
       merge_options=[]</span><span class="svn_1007000">,
       allow_mixed_revisions=false</span><span class="svn_1008000">,
       ignore_mergeinfo=not notice_ancestry</span> )
</pre>
...
<p>merge_options (a list of strings),
is used to pass additional command line arguments to the merge
processes (internal or external).</p>

<p>The internal subversion diff supports the following options:
</p>

<ul>
<li>--ignore-space-change, -b</li>
<li>--ignore-all-space, -w</li>
<li>--ignore-eol-style</li>
<li>--unified, -u (for compatibility, does nothing).</li>
</ul>
<div class="svn_1007000">
<p>
If allow_mixed_revisions is False, and merge_target is a mixed-revision
working copy, raise SVN_ERR_CLIENT_MERGE_UPDATE_REQUIRED.
</p>
<p>
...
<div class="svn_1008000">
<p>
If ignore_mergeinfo is true, disable merge tracking, by treating the
...
<div class="svn_1005000">
<h4><a name="pysvn_client_merge_peg2"><a href="#pysvn_module">pysvn</a>.<a href="#pysvn_client">Client</a>.merge_peg2</a></h4>
<pre>
merge_peg2( sources,
            ranges_to_merge,
            peg_revision,
            ...
            dry_run=False,
            record_only=True,
            merge_options=[]<span class="svn_1007000">,
            allow_mixed_revisions=false</span><span class="svn_1008000">,
            ignore_mergeinfo=false</span> )
</pre>
<p>Apply the differences between the ranges_to_merge in sources to a working copy path, target_wcpath.
ranges_to_merge is a list of tuples with the start and end revisions to be merged.
</p>
<p>peg_revision indicates in which revision url_or_path is valid.
If peg_revision.kind is opt_revision_kind.unspecified, then it defaults to
opt_revision_kind.head for URLs or opt_revision_kind.working for
WC targets.
</p>
<p>The depth is one of the pysvn.depth enums.
...
<div class="svn_1005000">
<h4><a name="pysvn_client_merge_reintegrate"><a href="#pysvn_module">pysvn</a>.<a href="#pysvn_client">Client</a>.merge_reintegrate</a></h4>
<pre>
...
<p>Lump-merge all of url_or_path unmerged changes into local_path.
</p>
...
<pre>
mkdir( url_or_path,
       log_message<span class="svn_1005000">,
       make_parents,
       revprops</span> )
...
<p>make_parents and revprops TBD</p>
...
<div class="svn_1005000">
<h4><a name="pysvn_client_move2"><a href="#pysvn_module">pysvn</a>.<a href="#pysvn_client">Client</a>.move2</a></h4>
<pre>
move2( sources,
       dest_url_or_path,
       move_as_child=False,
       make_parents=False,
       revprops<span class="svn_1008000">,
       allow_mixed_revisions=False,
       metadata_only=False</span> )
</pre>
<p>
Duplicate something in working copy or repos, remembering history.
The src_revision defaults to pysvn.Revision( opt_revision_kind.head )
...
<p>
If not None, revprop is a list of strings holding additional,
custom revision properties to be set on the new revision in
...
<div class="svn_1008000">
<p>
If allow_mixed_revisions is False, SVN_ERR_WC_MIXED_REVISIONS
will be raised if the move source is a mixed-revision subtree.
</p>
<p>
If allow_mixed_revisions is True, a mixed-revision move source is
...
compatibility to older versions of subversion is required.
</p>
<p>
If metadata_only is TRUE and moving a file in a working copy,
everything in the metadata is updated as if the node is moved, but the
...
<ul>
<li>WC  -&gt; WC:   move and schedule for addition (with history)</li>
<li>WC  -&gt; URL:  immediately commit a move of WC to URL</li>
<li>URL -&gt; WC:   check out URL into WC, schedule for addition</li>
<li>URL -&gt; URL:  complete server-side move; used to branch and tag</li>
</ul>
</p>
<p>If the destination is a URL the <a href="#pysvn_client_callback_get_log_message">client_get_log_message</a>
callback must be implemented to return a log message.
...
<div class="svn_1007000">
<h4><a name="pysvn_client_propdel_local"><a href="#pysvn_module">pysvn</a>.<a href="#pysvn_client">Client</a>.propdel_local</a></h4>
<pre>
...
<p>
Delelte propname fromn each path in the list.
The paths must be all working copy paths.
</p>
<p>
If depth is svn_depth_empty, set the property on each member of
targets only; if svn_depth_files, set it on targets and their
file children (if any); if svn_depth_immediates, on targets and all
of their immediate children (both files and directories); if
svn_depth_infinity, on targets and everything beneath them.
</p>
<p>
changelists is an list of string changelist
...
altogether None), no changelist filtering occurs.
</p>
<p>
...
<div class="svn_1007000">
<h4><a name="pysvn_client_propdel_remote"><a href="#pysvn_module">pysvn</a>.<a href="#pysvn_client">Client</a>.propdel_remote</a></h4>
<pre>
commit_info = \
...
using the log message returned from the context log messages callback.
</p>
<p>
If the property has changed on url since revision
base_revision_for_url (must be opt_revision_kind.number), no
...
propget( prop_name,
         ...
         get_inherited_props=False</span> )
</pre>
...
<ul>
<li>0 - dictionary with keys of url_or_path and values of
the prop_name.</li>
<li>1 - dictionary with keys of url_or_path and values of
the prop_name that where inherited.</li>
</ul>
</div>
...
<pre>
<span class="svn_1005000">commit_info = \
</span>propset( prop_name,
         prop_value,
         url_or_path,
         revision=pysvn.Revision(),
         recurse=False<span class="svn_1002000">,
...
<p>If allow_unver_obstructions is False then the update will abort
...
<div class="svn_1007000">
<h4><a name="pysvn_client_propset_local"><a href="#pysvn_module">pysvn</a>.<a href="#pysvn_client">Client</a>.propset_local</a></h4>
<pre>
...
<p>
Set propname to propval on each path in the list.
The paths must be all working copy paths.
</p>
<p>
If depth is svn_depth_empty, set the property on each member of
...
"svn:"), then the caller is responsible for ensuring that
...
property is not appropriate for targets), or
SVN_ERR_BAD_MIME_TYPE (if propname is "svn:mime-type", but 
...
<div class="svn_1007000">
<h4><a name="pysvn_client_propset_remote"><a href="#pysvn_module">pysvn</a>.<a href="#pysvn_client">Client</a>.propset_remote</a></h4>
<pre>
commit_info = \
...
If the property has changed on url since revision
base_revision_for_url (which must not be SVN_INVALID_REVNUM), no
change will be made and an error will be returned.
</p>
<p>
If non None, revprops is a list of tuples, (string names, string value),
holding additional, custom revision properties to be set on the new revision. This
list cannot contain any standard Subversion properties.
</p>
<p>
commit_info returns the detail of the successful commit.
</p>
...
not appropriate for url), or SVN_ERR_BAD_MIME_TYPE (if propname
is "svn:mime-type", but propval is not a valid mime-type).
</p>
</div>
...
relocate( from_url,
          to_url,
          path,
          recurse=True<span class="svn_1007000">,
          ignore_externals=True</span> )
</pre>
<p>Relocate the working copy from from_url to to_url of path.
</p>
<div class="svn_1007000">
<p>Set ignore_externals to False to work on the externals.</p>
<p>Note: recurse is ignored since subversion 1.7</p>
</div>
...
remove( url_or_path_list,
        force=False<span class="svn_1005000">,
        keep_local=False,
        revprops</span> )
</pre>
...
<div class="svn_1005000">
<p>Set keep_local to True to prevent the local file from being delete.
</p>
<p>revprops TBD</p>
</div>
...
<div class="svn_1005000">
<h4><a name="pysvn_client_remove_from_changelists"><a href="#pysvn_module">pysvn</a>.<a href="#pysvn_client">Client</a>.remove_from_changelists</a></h4>
<pre>
...
<pre>
revert( path,
        recurse=False<span class="svn_1005000">,
        depth=depth,
        changelists=[]</span><span class="svn_1009000">,
...
revpropdel( prop_name,
            url,
            revision=pysvn.Revision( opt_revision_kind.head ),
            force=False<span class="svn_1008000">,
            original_prop_value=None</span> )
</pre>
<p>
...
<div class="svn_1008000">
<p>
If original_prop_value is specified its string value is compared to the current value of the property and
only if it matches does the revpropdel succeed.
</p>
</div>
...
<span class="svn_1007000">The old prop value is returned.</span>
</p>
<div class="svn_1008000">
<p>
If original_prop_value is specified its string value is compared to the current value of the property and
only if it matches does the revpropset succeed.
</p>
</div>
...
<div class="svn_1008000">
<h4><a name="pysvn_client_status2"><a href="#pysvn_module">pysvn</a>.<a href="#pysvn_client">Client</a>.status2</a></h4>
<pre>
status_list = \
status2( path,
         recurse=True,
         ...
         depth=depth,
         changelist=[],
         depth_as_sticky=False<span class="svn_1009000">,
         check_out_of_date=update,
         check_working_copy=True</span> )
</pre>
...
Set ignore_externals to True to ignore externals definitions.
</p>
...
<li>ignore_externals - 
  ...
  with the wc_notify_action.external action before 
  handling each externals definition, and with 
  wc_notify_action.completed after each.</li>

<li>depth - can be used as in place of recurse. depth is one of the pysvn.depth enums.</li>

<li class="svn_1009000">If check_out_of_date is set, contact the repository and
  augment the status structures with information about
  out-of-dateness (with respect to revision).  Also, if
  result_rev is not NULL, set *result_rev to the actual
  revision against which the working copy was compared (
  result_rev is not meaningful unless check_out_of_date is
  True). check_out_of_date deafults to the value of update.</li>

<li class="svn_1009000">If check_working_copy is not set, do not scan the working
  copy for local modifications. This parameter will be ignored
  unless check_out_of_date is set.  When set, the status
...
<li><div class="svn_1005000">
<p>depth - can be used as in place of recurse. depth is one of the pysvn.depth enums.
</p>
</div></li>
</ul>
</p>
...
its sticky ambient depth value to depth.</p>
...
update( path,
        ...
        depth=depth,
        depth_is_sticky=False,
        allow_unver_obstructions</span><span class="svn_1007000">,
        adds_as_modifications=False,
        make_parents=False</span> )
</pre>
...
<p>
If depth_is_sticky is set and depth is not
...
properties of obstructing items are set equal to the base properties.
If allow_unver_obstructions is False then the update will abort
if there are any unversioned obstructing items.
</p>
</div>
<div class="svn_1007000">
...
<div class="svn_1009000">
<h4><a name="pysvn_client_vacuum"><a href="#pysvn_module">pysvn</a>.<a href="#pysvn_client">Client</a>.vacuum</a></h4>
<pre>
vacuum( path,
...
<p>
If remove_unversioned_items is True, remove unversioned items
in path after successful working copy cleanup.
</p>
<p>
If remove_ignored_items is True, remove ignored unversioned items
in path after successful working copy cleanup.
</p>

<p>
If fix_recorded_timestamps is True, this function fixes recorded
timestamps for unmodified files in the working copy, reducing comparision
time on future checks.
</p>
<p>If vacuum_pristines is True, and dir_abspath points to the working
...
<li>kind - node_kind - one of the pysvn.<a href="#pysvn_node_kind">node_kind</a> values</li>
<li>text_mod - int - is != 0 if the text in this path has been modified</li>
<li>prop_mod - int - is != 0 if the properties in this path have been modified</li>
...
<p>
Changes will be limited to those within base_dir, and if
low_water_mark is set to something other than SVN_INVALID_REVNUM(-1)
it is assumed that the client has no knowledge of revisions prior to
low_water_mark.  Together, these two arguments define the portion of
...
<p>
The editor passed to this function should be aware of the fact
that, if send_deltas is False, calls to its change_dir_prop(),
...
<p>
If send_deltas is True, the text and property deltas for changes
will be sent, otherwise null text deltas and empty prop changes will be
used.
</p>
<p>
Note: This editor driver passes SVN_INVALID_REVNUM (-1) for all
...
<h2><a href="#pysvn_module">pysvn</a>.<a name="pysvn_opt_revision_kind">opt_revision_kind - subversion
...
<h2><a href="#pysvn_module">pysvn</a>.<a name="pysvn_wc_notify_action">wc_notify_action - subversion notification callback action enumeration</a></h2>
<ul>
...
<h2><a href="#pysvn_module">pysvn</a>.<a name="pysvn_wc_status_kind">wc_status_kind - subversion status kind enumeration</a></h2>
<ul>
...
<h2><a href="#pysvn_module">pysvn</a>.<a name="pysvn_wc_merge_outcome">wc_merge_outcome - subversion merge outcome enumeration</a></h2>
<ul>
...
<h2><a href="#pysvn_module">pysvn</a>.<a name="pysvn_wc_notify_state">wc_notify_state - subversion notify callback state enumeration</a></h2>
<ul>
...
<h2><a href="#pysvn_module">pysvn</a>.<a name="pysvn_wc_schedule">wc_schedule - subversion status schedule enumeration</a></h2>
<ul>
...
<h2><a href="#pysvn_module">pysvn</a>.<a name="pysvn_node_kind">node_kind - subversion node kind enumeration</a></h2>
<ul>
<li>none - absent</li>
...
<h2><a href="#pysvn_module">pysvn</a>.<a name="pysvn_depth">depth - subversion depth enumeration</a></h2>
<ul>
...
<li>exclude - not used yet</li>
<li>files - D + its file children, but not subdirs.  Updates will pull in any
     files not already present, but not subdirectories.</li>
<li>immediates - D + immediate children (D and its entries).  Updates will pull in
     any files or subdirectories not already present; those
     subdirectories' this_dir entries will have depth-empty.</li>
<li>infinity - D + all descendants (full recursion from D).  Updates will pull
     in any files or subdirectories not already present; those
     subdirectories' this_dir entries will have depth-infinity.
     Equivalent to the pre-1.5 default update behavior.</li>
<li>unknown - Depth undetermined or ignored</li>
</ul>

<p>Copyright &copy; 2004-2009 Barry A. Scott. All rigths reserved.</p>
<script type="text/javascript">
// expect this to fail on IE and other browsers that don't support
changeDisplay( 1009000 );
changeVisual( "hilite" );
